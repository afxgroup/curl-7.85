...
ACLOCAL = ${SHELL} '/mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ppc-amigaos-ar
AR_FLAGS = cr
AS = as
AUTOCONF = ${SHELL} '/mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0/missing' autoconf
AUTOHEADER = ${SHELL} '/mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0/missing' autoheader
AUTOMAKE = ${SHELL} '/mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0/missing' automake-1.16
AWK = mawk
BLANK_AT_MAKETIME = 
CC = ppc-amigaos-gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -mcrt=clib4 -D__USE_INLINE__ -Werror-implicit-function-declaration -O2 -Wno-system-headers
CFLAG_CURL_SYMBOL_HIDING = -fvisibility=hidden
CONFIGURE_OPTIONS = " '--host=ppc-amigaos' '--prefix=/opt/packages/curl-7.85.0_amd64/usr/ppc-amigaos/SDK/local/clib4' 'CPPFLAGS=-mcrt=clib4 -D__USE_INLINE__' 'CFLAGS=-mcrt=clib4 -D__USE_INLINE__' 'LDFLAGS=-mcrt=clib4' 'LIBS=-lpthread -latomic -lauto' '--with-openssl' '--disable-shared' '--disable-ntlm' '--disable-ipv6' '--disable-manual' '--with-nghttp3' '--with-ca-fallback' '--without-default-ssl-backend' '--enable-openssl-auto-load-config' 'host_alias=ppc-amigaos'"
CPP = ppc-amigaos-gcc -E
CPPFLAGS = -mcrt=clib4 -D__USE_INLINE__
...
CURL_NETWORK_AND_TIME_LIBS = -lpthread -latomic -lauto
CURL_NETWORK_LIBS = -lpthread -latomic -lauto
CURL_PLIST_VERSION = 7.85.0
CURL_WITH_MULTI_SSL = 
CYGPATH_W = echo
...
LDFLAGS = -mcrt=clib4
LIBCURL_LIBS = -lrtmp -lssl -lcrypto -lssl -lcrypto -lz -lpthread -latomic -lauto -lpthread
LIBCURL_NO_SHARED =  -lrtmp -lssl -lcrypto -lssl -lcrypto   -lz -lpthread -latomic -lauto -lpthread
LIBOBJS = 
LIBS = -lrtmp -lssl -lcrypto -lssl -lcrypto -lz -lpthread -latomic -lauto
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0/missing' makeinfo
MANIFEST_TOOL = :
MANOPT = -man
...
SUPPORT_FEATURES = AsynchDNS HSTS HTTP2 HTTPS-proxy Largefile SSL TLS-SRP alt-svc brotli libz threadsafe
SUPPORT_PROTOCOLS = DICT FILE FTP FTPS GOPHER GOPHERS HTTP HTTPS IMAP IMAPS MQTT POP3 POP3S RTMP RTSP SMTP SMTPS TELNET TFTP
USE_ARES = 
USE_BEARSSL = 
USE_GNUTLS = 
USE_HYPER = 
...
abs_builddir = /mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0
abs_srcdir = /mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0
abs_top_builddir = /mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0
abs_top_srcdir = /mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0
ac_ct_AR = 
ac_ct_CC = 
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /mnt/Sviluppo/Sviluppo/Amiga/libs/curl-7.85.0/install-sh
...
pdfdir = ${docdir}
prefix = /opt/packages/curl-7.85.0_amd64/usr/ppc-amigaos/SDK/local/clib4
